...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        empLogin.setBackground(new java.awt.Color(153, 153, 153));
        empLogin.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        empLogin.setForeground(new java.awt.Color(204, 0, 0));
        empLogin.setText("Login");
        empLogin.setToolTipText("");
        empLogin.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 153)));
        empLogin.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        empLogin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                empLoginActionPerformed(evt);
            }
        });
        jPanel1.add(empLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 180, 50));
        ...
        btnForgotPass.setBackground(new java.awt.Color(153, 153, 153));
        btnForgotPass.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        btnForgotPass.setForeground(new java.awt.Color(204, 0, 0));
        btnForgotPass.setText("Forgot Password");
        btnForgotPass.setToolTipText("");
        btnForgotPass.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 153)));
        ...
        jPanel1.add(btnForgotPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 180, 180, 50));
    ...
    private boolean isValidPassword(String Password)
    {
        ...
        //at least 8 characters, containing at least one digit, one uppercase letter, and one lowercase letter
        return Password.matches(passFormat);
    }
